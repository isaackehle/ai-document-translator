...
Agents working in this vault should automatically load and use all skills located in the `.agents/skills/` directory. These skills provide specialized instructions and workflows for specific tasks including conventional commits, FastAPI development, and skill discovery.
